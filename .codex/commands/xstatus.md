...
2. **Load module**: Read `.codex/skills/orchestrator-playbook/modules/07-status-report.md` for the full procedure
3. **Collect data**:
...
5. **Render HTML**: Read template at `.codex/skills/orchestrator-playbook/templates/status-report.html`, perform string substitution
...
- 3 workflow modes each have distinct layout:
