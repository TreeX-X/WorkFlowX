Invoke the orchestratorX agent to execute the following requirement in local mode (Mode B: local).
...
4. Invoke promptMasterX to optimize the execution instructions (Module 04)
