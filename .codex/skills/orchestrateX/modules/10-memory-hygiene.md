...
2. Compare observations against current files (Section 8.1/Section 8.2, code, Hybrid Tree evaluation sections).
...
5. Record reconciliation summary in the Parent Section 8.2 Memory Pointers update log.
