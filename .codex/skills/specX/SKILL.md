...
1. Read Parent Section 8.2 to collect the exact entry names and relation summaries (the "trunk").
...
4. For knowledge retrieval, use exact entry names from the manifest or Parent Section 8.2 trunk.
