...
- **Entry**: Environment init (module 01, **MCP probe must precede everything**) -> promptMasterX optimization (module 04) -> **Has Hybrid Tree**: Core Iteration Loop. **No Hybrid Tree**: Simple Iteration Loop.
