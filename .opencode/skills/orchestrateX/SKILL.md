...
> When Mode B has no existing PRD or Hybrid Tree, Main Agent auto-generates a minimal Hybrid Tree before entering the Core Iteration Loop. This replaces the former Simple Iteration Loop path.
