...
- **Load workflow logic**: Before execution, load skill `orchestrator-playbook` for the complete workflow definition (Mode A/B/C, core iteration loop, Hybrid Tree routing, Auto-Routing, Start Rule).
