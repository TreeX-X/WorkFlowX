...
tools: [Bash, Read, Write, Edit, Glob, Grep, TodoWrite, mcp]
---
...
After implementation, output a standardized Bus Payload for evaluatorX. Follow the format defined in `.claude/skills/orchestrator-playbook/modules/02-bus-payload.md` (Payload Type 1).
