...
<p align="center">
  <img src="docs/design/images/01a-architecture-zh.png" alt="WorkflowX 系统架构 · 编排层" width="720" />
  <br/>
  <sub>编排层：orchestratorX 调度 4 个子智能体（promptMasterX / coderX / evaluatorX / abstracterX）</sub>
</p>
<p align="center">
  <img src="docs/design/images/01b-architecture-zh.png" alt="WorkflowX 系统架构 · 数据与通信" width="720" />
  <br/>
...
<p align="center">
  <img src="docs/design/images/03a-token-optimization-zh.png" alt="WorkflowX Token 优化 · L1 Section-Level Caching" width="720" />
  <br/>
  <sub>L1：混合文档拓扑排序，严格分区命中 LLM Prompt Cache</sub>
</p>
<p align="center">
  <img src="docs/design/images/03b-token-optimization-zh.png" alt="WorkflowX Token 优化 · 干叶分离与记忆图谱" width="720" />
  <br/>
...
<p align="center">
  <img src="docs/design/images/05a-capabilities-zh.png" alt="WorkflowX 独有能力 · 数据与质量" width="720" />
  <br/>
  <sub>Hybrid Tree 需求追踪 / AC 交叉验证 / Prompt 优化引擎</sub>
</p>
<p align="center">
  <img src="docs/design/images/05b-capabilities-zh.png" alt="WorkflowX 独有能力 · 安全与发现" width="720" />
  <br/>
...
| **OpenAI Codex** | `.codex/` | 3 种模式 | agents (`.toml`) + skills，完全对等 |
